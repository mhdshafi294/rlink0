    ...
    <div id="partners" className="relative w-full overflow-hidden">
      ...
      <Container>
        <div className="flex flex-col justify-center items-center pt-0">
          <h2 className="text-center text-xl sm:text-5xl font-bold tracking-[-0.02em] leading-[1.3] mt-0 mb-5 md:mb-10 text-white">
            Our Clients
          </h2>
          <p className="text-slate-50 text-center md:text-[22px] leading-[1.3] font-normal mt-0 mb-[72px] mx-0">
            Our clients are also our partners through this successful journey
            <br className="" /> From next-gen startups to established
            enterprises.
          </p>
          <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 gap-y-8 gap-x-2 md:gap-y-8 md:gap-x-6 w-full place-items-center">
            {clients}
          </div>
        </div>
        <div className="relative pointer-events-none select-none h-[600px] overflow-hidden mx-auto my-0 planet_separator z-50 ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="872"
            height="731"
            fill="none"
            className="absolute -translate-x-2/4 -translate-y-2/4 left-2/4 top-2/4 radial_mask"
          >
